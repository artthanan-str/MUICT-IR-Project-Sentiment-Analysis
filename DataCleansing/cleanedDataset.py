train = [("So there is no way for me to plug it in here in the US unless I go by a converter", "0"),
...
("If the two were seperated by a mere ft I started to notice excessive static and garbled sound from the headset", "0"),
...
("I've owned this phone for months now and can say that it's the best mobile phone I've had", "1"),
...
("You need at least mins to get to your phone book from the time you first turn on the phoneBattery life is short", "0"),
("It has kept up very well", "1"),
("Poor Talk Time Performance", "0"),
("The case is great and works fine with the ", "1"),
("worthless product", "0"),
("It has a great camera thats MP, and the pics are nice and clear with great picture quality", "1"),
...
("VERY DISAPPOINTED", "0"),
("I even dropped this phone into a stream and it was submerged for seconds and it still works great!", "1"),
("I have been very happy with the and have had NO complaints from any one regarding my sound quality on their end", "1"),
...
("The one big drawback of the MP player is that the buttons on the phone's front cover that let you pause and skip songs lock out after a few seconds", "0"),
...
("Mic Doesn't work", "0"),
("Even in my BMW series which is fairly quiet, I have trouble hearing what the other person is saying", "0"),
("Great choice!", "1"),
("Nice docking station for home or work", "1"),
("This is a beautiful phone", "1"),
("Love this product", "1"),
("Do Not Buy for Dwrongly advertised for D", "0"),
("This is a great little item", "1"),
("I love this phone , It is very handy and has a lot of features ", "1"),
("I purchased this and within days it was no longer working!!!!!!!!!", "0"),
...
("This item worked great, but it broke after months of use", "0"),
...
("Best I've found so far I've tried other bluetooths and this one has the best quality (for both me and the listener) as well as ease of using", "1"),
...
("I received my supposedly new motorola and apparently there was not a match between the phone and the charger", "0"),
...
("I love my headset My Jabra bluetooth headset is great, the reception is very good and the ear piece is a comfortable fit", "1"),
("The camera, although rated at an impressive megapixels, renders images that fall well below expectations of such a relatively high resolution", "0"),
("I purcashed this for the car charger and it does not work", "0"),
("Sound quality on both end is excellent, I use headset to call my wife and ask my wife to use headset to call me !", "1"),
...
("What a waste", "0"),
("During several different minute calls, I experienced drops and it was in an area that had bars", "0"),
("I was not happy with this item", "0"),
("very disappointed", "0"),
("The phone takes FOREVER to charge like to hours literally", "0"),
...
("After months, screen just went black all of a sudden", "0"),
("I Was Hoping for More", "0"),
("Audio Quality is poor, very poor", "0"),
("I had absolutely no problem with this headset linking to my Blackberry Curve!", "1"),
("I know that sounds funny, but to me it seemed like sketchy technology that wouldn't work wellWell, this one works great", "1"),
("I've bought $ wired headphones that sound better than these", "0"),
...
("Great Value", "1"),
("Doesn't work at all I bougth it for my Lc and its not working", "0"),
...
("I connected my wife's bluetooth,(Motorola HS) to my phone and it worked like a charm whether the phone was in my pocket or the case", "1"),
("I put the latest OS on it (vg), and it now likes to slow to a crawl and lock up every once in a while", "0"),
...
("great headset, very impressed - H", "1"),
("The mega pixel camera, being a part of a phone, is reasonably good", "1"),
("I've had this for nearly years and it has worked great for me", "1"),
...
("I ordered this for sony Ericsson Wi but I think it only worked once (thats when I first used it)", "0"),
...
("I gave it stars because of the sound quality", "1"),
...
("Battery life still not long enough in Motorola Razor Vi", "0"),
("Sending it back", "0"),
...
("My -year old Nokia from Tracfone holds the charge a lot better than this", "0"),
...
("I have - bars on my cell phone when I am home, but you cant not hear anything", "0"),
...
("VERY comfortable", "1"),
("The battery is working well as a replacement for the original that came with the phone over years ago", "1"),
...
(" long lasting battery (you don't have to recharge it as frequentyly as some of the flip phones)", "0"),
...
("Was not happy", "0"),
("A PIECE OF JUNK THAT BROKE AFTER BEING ON MY PHONE FOR DAYS!!!", "0"),
...
("First off the reception sucks, I have never had more than bars, ever", "0"),
...
("It definitely was not as good as my S", "1"),
("awesome device", "1"),
("Waste of money", "0"),
...
("An Awesome New Look For Fall !", "1"),
...
("I used to talk on it for - / hours and the battery would be literally drained and dying", "0"),
("If you don't find it, too bad, as again the unit comes with one earpad onlyI would not recommend this to anyone", "0"),
("Very Displeased", "0"),
...
("I would recommend purchasing the Jabra JX- series which works flawlessly with my Moto Q, go figure", "1"),
...
("I even fully charged it before I went to bed and turned off blue tooth and wi-fi and noticed that it only had % left in the morning", "0"),
...
("Very well made and fits my Surefire GX perfectly", "1"),
("Horrible phone", "0"),
("BT battery junk!", "0"),
...
("I also didn't like the on button, it felt like it would crack with use", "1"),
("I have had TMobile service for or years now, and I am pretty happy with it", "1"),
...
("Very easy to use", "1"),
("Uncomfortable In the Ear, Don't use with LG VX (EnV)", "0"),
...
("I would definitely recommend the Jabra BTv for those who are looking for comfort, clarity and a great price!", "1"),
("I had Verizon years ago and really liked their service", "1"),
("Pretty piece of junk", "0"),
("Plug was the wrong size", "0"),
("Works as described", "1"),
("Save your money I've had this item for months now", "0"),
("Bad Purchase", "0"),
("WELL IM SATISFIED", "1")]